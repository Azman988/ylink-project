    ...
    return (
        <div className="lg:col-span-2 space-y-6 animate-fade-in-up" style={{ animationDelay: '0.1s' }}>
            <div className="bg-white rounded-3xl p-8 border border-slate-200 shadow-sm">
                <h2 className="text-2xl font-bold text-slate-900 mb-6">Why Choose YLink Repairs?</h2>
            ...
            {/* Desktop Filler: Strict Data Privacy */}
            <div className="hidden lg:block bg-gradient-to-br from-slate-800 to-slate-900 rounded-3xl p-8 text-white shadow-xl shadow-slate-900/20 relative overflow-hidden border border-slate-700 animate-fade-in-up" style={{ animationDelay: '0.2s' }}>
                ...
                <div className="relative z-10">
                    ...
                    <h3 className="text-2xl font-extrabold mb-3">Strict Data Privacy</h3>
