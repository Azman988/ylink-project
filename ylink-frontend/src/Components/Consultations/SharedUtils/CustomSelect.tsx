...
import type { SelectOption } from "./Others";
    ...
    return (
        <div className="relative" ref={dropdownRef}>
            <div
                ...
                className={`w-full px-4 py-3.5 bg-slate-50 border rounded-xl flex items-center justify-between cursor-pointer transition-all ${isOpen ? 'border-blue-500 bg-white ring-2 ring-blue-500/20' : 'border-slate-200 hover:border-slate-300'
                    }`}
            >
