import { BatteryCharging, MapPin, Phone, ShieldCheck, Sun, Zap } from "lucide-react"
    ...
    return (
        <div className="lg:col-span-2 space-y-6 animate-fade-in-up" style={{ animationDelay: '0.1s' }}>
            <div className="bg-white rounded-3xl p-8 border border-slate-200 shadow-sm">
                <h2 className="text-2xl font-bold text-slate-900 mb-6">Why Switch to YLink Solar?</h2>
            ...
            {/* Desktop Filler: Local Support Promise */}
            <div className="hidden lg:block bg-gradient-to-br from-amber-500 to-orange-600 rounded-3xl p-8 text-white shadow-xl shadow-amber-500/20 relative overflow-hidden animate-fade-in-up" style={{ animationDelay: '0.2s' }}>
                {/* Background Icon */}
                ...
                <div className="relative z-10">
                    ...
                    <h3 className="text-2xl font-extrabold mb-2">Local Support Promise</h3>
            ...
            {/* Desktop Filler: Quick Contact */}
            <div className="flex bg-blue-50/50 border border-blue-100 rounded-3xl p-6 items-center gap-5 shadow-sm animate-fade-in-up" style={{ animationDelay: '0.3s' }}>
                <div className="w-12 h-12 bg-white text-blue-600 rounded-full flex items-center justify-center flex-shrink-0 shadow-sm border border-blue-100">
                    <Phone className="w-5 h-5" />
                </div>
                <div>
                    <h4 className="font-bold text-slate-900 text-sm">Need immediate answers?</h4>
                    <p className="text-xs text-slate-500 mt-1 font-medium">Speak with our engineers directly at 0800-YLINK-SOLAR.</p>
                </div>
            </div>
        </div>
    )
