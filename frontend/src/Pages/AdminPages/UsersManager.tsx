                            ...
                            return (
                                ...
                                >
                                    ...
                                    <div className="relative z-10">
                                        ...
                                        {user.isVerified 
                                            ? ( 
                                                <p className="text-[11px] font-mono text-emerald-600 mt-1 flex items-center gap-1 px-2 py-1 bg-emerald-50 border border-emerald-200 rounded-lg w-fit">
                                                <ShieldCheck size={12} /> Verified Account </p> ) 
                                            : (
                                                <p className="text-[11px] font-mono text-amber-600 mt-1 flex items-center gap-1 px-2 py-1 bg-amber-50 border border-amber-200 rounded-lg w-fit">
                                                <ShieldAlert size={12} /> Unverified Account </p>
                                            )}
