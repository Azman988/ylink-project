...
const user: any = { name: 'Usman Azeez', email: 'azman@gmail.com', isAdmin: true };
...
export function Header() {
    ...
    return (
        <header className="bg-white/80 backdrop-blur-md border-b border-slate-200 shadow-sm py-3 sm:py-4 px-4 sm:px-6 fixed w-full top-0 z-50 transition-all print:hidden">
            <div className="max-w-7xl mx-auto flex items-center justify-between gap-4">
                ...
                <div className='flex items-center gap-3 sm:gap-4'>
                    ...
                    {/* Cart Button */}
                    <button
                        className='relative p-2.5 rounded-full bg-slate-50 text-slate-600 hover:bg-slate-100 hover:text-blue-600 transition-all duration-300 cursor-pointer shadow-sm border border-slate-100'
                    ...
                    <div className='relative flex items-center'>
                        {user ? (
                            ...
                            <>
                                <Link to='/signIn' className='hidden md:flex items-center justify-center gap-2 px-5 py-2.5 rounded-xl bg-blue-600 hover:bg-slate-900 text-white font-bold text-sm transition-all shadow-md shadow-blue-600/10 cursor-pointer'>
