        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div className="animate-fade-in-up">
            ...
            <div className="flex flex-wrap items-center gap-4">
              <Link to="/shop" className="px-8 py-4 bg-blue-600 hover:bg-blue-500 text-white font-bold rounded-xl transition-all shadow-lg shadow-blue-600/30 flex items-center gap-2 cursor-pointer">
                Shop Hardware <ArrowRight className="w-5 h-5" />
              </Link>
              <Link to="/consultation" className="px-8 py-4 bg-white/10 hover:bg-white/20 border border-white/20 text-white font-bold rounded-xl transition-all cursor-pointer">
          ...
          {/* Hero Visual Mockup */}
          <div className="hidden lg:flex justify-end relative animate-fade-in-up duration-200">
            <div className="relative w-full max-w-md aspect-square bg-gradient-to-tr from-slate-800 to-slate-700 rounded-full border-8 border-slate-800 shadow-2xl flex items-center justify-center">
              ...
              <Laptop className="absolute bottom-20 left-10 w-32 h-32 text-blue-400 opacity-90" />
              <div className="absolute inset-0 bg-gradient-to-t from-slate-900/80 to-transparent rounded-full"></div>
            </div>
          </div>
        </div>
      </div>
