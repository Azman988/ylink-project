        ...
        <div className="min-h-screen bg-slate-50 text-slate-800 font-sans pt-28 pb-20 relative overflow-hidden">
            <div className="max-w-5xl mx-auto px-4 sm:px-6">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6 mb-20">
                    ...
                    {/* Phone (Click to dial) */}
                    <a href="tel:08100673097" className="bg-white p-6 rounded-3xl border border-slate-200 shadow-sm flex flex-col items-center text-center transition-all duration-300 hover:shadow-md hover:border-blue-300 group cursor-pointer">
                    ...
                    <a href="mailto:ylinktech7@gmail.com" className="bg-white p-6 rounded-3xl border border-slate-200 shadow-sm flex flex-col items-center text-center transition-all duration-300 hover:shadow-md hover:border-purple-300 group cursor-pointer">
                        ...
                        <p className="text-sm font-black text-purple-600 truncate w-full">ylinktech7@gmail.com</p>
                    </a>
